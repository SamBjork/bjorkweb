...
const CreativeSection = () => {
  return (
    <div id="blogs">
      <Container>
        <h1 className="text-center font-details-b pb-4">Creative Department</h1>
        <CardDeck>
          <Tilt>
            <Card className="card-resize">
              <Card.Img
                ...
                variant="top"
                src="..\..\assets\img\carousal\slide_1.webp"
                alt="Creative 1"
              />
              <Card.Body>
                <a
          ...
          <Tilt>
            <Card className="card-resize">
              ...
              <Card.Body>
                <a
                  className="text-dark text-decoration-none"
                  href="https://medium.com/better-programming/why-i-find-javascripts-destructuring-so-useful-7be41d9ba609"
                  target="_blank"
                >
                  <Card.Title>
